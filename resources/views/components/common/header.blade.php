        ...
        <nav class="navbar">
            ...
            <div class="navbar-bottom">
                <div class="search-bar">
                    ...
                    <a href="#" style="margin-right:5px" class="search-icon">
                    </a>
                </div>
    ...
    <div class="container">
        <div class="header-top-info">
            <ul class="left-section">
                <li><a href="{{route('bizeulasin')}}">İletişim</a></li>
                <li><a href="{{route('hakkimizda')}}">Hakkımızda</a></li>
                <li><a href="#">Garanti ve İade Şartları</a></li>
                <li><a href="{{route('dropshipping')}}">Dropshipping</a></li>
            </ul>
            <ul class=" right-section">
                <li><a href="">0850 520 08 80</a></li>
    ...
    <div class="container">
        <div class="navbar">
            ...
            <div class="right-section">
                ...
                <div class="login-btn">Giriş Yap
                    <div class="dropdown-box">
                        <a class="login-link" href="">Üye Girişi</a>
