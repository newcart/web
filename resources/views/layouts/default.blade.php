...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?_v={{ env('ASSETS_VER') }}">
    <link rel="stylesheet" href="assets/css/header.css?_v={{ env('ASSETS_VER') }}">
    <link rel="stylesheet" href="assets/css/footer.css?_v={{ env('ASSETS_VER') }}">
    <link rel="stylesheet" href="assets/css/main.css?_v={{ env('ASSETS_VER') }}">
